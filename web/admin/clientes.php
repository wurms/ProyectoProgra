...
$pdf->Cell(335,5,utf8_decode("Reporte de clientes por Sucursal"),0,1,'R',0);
...
$pdf->Cell(335,15,utf8_decode("Reporte de Clientes"),0,0,'C',1);
$pdf->Ln(20);
...
$pdf->Cell(37.22,10,utf8_decode('Dirección'),0,0,'C',1);
$pdf->Cell(37.22,10,utf8_decode('Teléfono'),0,0,'C',1);
$pdf->Cell(37.22,10,utf8_decode('NIT'),0,0,'C',1);
$pdf->Cell(37.22,10,utf8_decode('Correo'),0,0,'C',1);
$pdf->Cell(37.22,10,utf8_decode('Estado'),0,0,'C',1);
$pdf->Cell(37.22,10,utf8_decode('Fecha Nacimiento'),0,1,'C',1);
$pdf->Ln(2);
