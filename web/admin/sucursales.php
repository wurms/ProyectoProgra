...
$pdf->Cell(196,5,utf8_decode("Reporte de sucursales de la compañia"),0,1,'R',0);
$pdf->Cell(196,5,utf8_decode("Con fecha el: ".$hoy),0,1,'R',0);
$pdf->Image('../img/ps.jpg',20,2.5,35);

$pdf->Ln(5);
$pdf->SetFont('Arial','B','16');
$pdf->SetFillColor(255,255,204);
$pdf->Cell(196,15,utf8_decode("Reporte de Sucursales"),0,0,'C',1);
$pdf->Ln(20);


$pdf->SetFont('Arial','B',10);
$pdf->SetFillColor(192,192,192);
$pdf->Cell(39.2,10,utf8_decode('ID Sucursal'),0,0,'C',1);
$pdf->Cell(39.2,10,utf8_decode('Nombre'),0,0,'C',1);
$pdf->Cell(39.2,10,utf8_decode('Dirección'),0,0,'C',1);
$pdf->Cell(39.2,10,utf8_decode('Encargado'),0,0,'C',1);
$pdf->Cell(39.2,10,utf8_decode('Telefono'),0,1,'C',1);
$pdf->Ln(2);
