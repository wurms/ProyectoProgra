      ...
      <div class="nav-bar">
        ...
        <div class="module-group right">
          ...
          <div class="module widget-handle language left">
            <ul class="menu">
              <li class="has-dropdown">
                <a href="vsucursal.php">ESPAÑOL</a>
                <ul>
                  <li>
                    <a href="vsucursalen.php">ENGLISH</a>
                  </li>
                </ul>
              </li>
            </ul>
      ...
      <div class="container">
        <div class="row">
          <div class="col-sm-12 text-center">
            <h4 class="uppercase mb16">Listado de Sucursales</h4>
            <p class="lead mb64">
              Estas son todas las sucursales en la plataforma.
            </p>
          </div>
        </div>
        <!--final columna-->
        <div class="row">
          <div class="col-md-100 col-md-offset-0 col-sm-100 col-sm-offset-0">
            <table class="table cart mb48">
              ...
              <tbody>
                <?php
                $consulta =  "SELECT * FROM tbsucursal LIMIT " .(($paginacion->get_page() - 1) * $resultados). "," . $resultados;
                foreach ($con->query($consulta) as $key) {
                  ...
                  <tr>
                    ...
                    <td>
                      <a href="msucursal.php?sid=<?=$key['sid']?>" class="remove-item" data-toggle="tooltip" data-placement="top" title="" data-original-title="Modificar Empleado">
