      ...
      <div class="nav-bar">
        ...
        <div class="module-group right">
          ...
          <div class="module widget-handle language left">
            <ul class="menu">
              <li class="has-dropdown">
                <a href="asucursalesen.php">ENGLISH</a>
                <ul>
                  <li>
                    <a href="asucursales.php">ESPAÑOL</a>
                  </li>
                </ul>
              </li>
            </ul>
      ...
      <div class="col-md-8 col-md-offset-2 col-sm-10 col-sm-offset-1">
        <div class="feature boxed bg-secondary">
          <form method="post" class="text-center form-envio" data-error="Complete all the fields correctly" data-success="¡New Member Entered!">
            <h4 class="uppercase mt48 mt-xs-0">Add New Branch</h4>
            <div class="overflow-hidden">
              ...
              <div class="col-sm-6 col-md-6 col-md-offset-0.5 input-with-label text-left">
                ...
                <span>Address:</span>
                <input type="text" name="direccion" class="validate-required" onpaste="return false" maxlength="50" placeholder="Address" required/>
              </div>
              <div class="col-sm-6 col-md-6 col-md-offset-0.5 input-with-label text-left">
                ...
                <span>Budget:</span>
                <input type="number" step="any" min="0" name="presupuesto" class="validate-required" placeholder="Budget" required/>
              </div>
              <hr>
            </div>
            <div class="overflow-hidden">
