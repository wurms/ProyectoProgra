...
if(isset($_POST['nombre'])){
  ...
  $insertar = "INSERT INTO tbsucursal VALUES('','$nombre','$direccion','$telefono','$presupuesto')";
...
<body class="scroll-assist">
      ...
      <div class="nav-bar">
        ...
        <div class="module-group right">
          ...
          <div class="module widget-handle language left">
            <ul class="menu">
              <li class="has-dropdown">
                <a href="asucursal.php">ESPAÑOL</a>
                <ul>
                  <li>
                    <a href="asucursalen.php">ENGLISH</a>
                  </li>
                </ul>
              </li>
            </ul>
  ...
  if(isset($_POST['nombre'])){
    if(@$var){
      ...
      swal("¡BUEN TRABAJO!", "¡Sucursal ingresada!", "success")
      </script>
      <?php
    }else{
      ?>
      ...
      <div class="col-md-8 col-md-offset-2 col-sm-10 col-sm-offset-1">
        <div class="feature boxed bg-secondary">
          <form method="post" class="text-center form-envio" data-error="Completa todos los campos correctamente" data-success="¡Nuevo miembro ingresado!">
            <h4 class="uppercase mt48 mt-xs-0">Agregar Sucursal</h4>
            <div class="overflow-hidden">
              ...
              <div class="col-sm-6 col-md-6 col-md-offset-0.5 input-with-label text-left">
                ...
                <span>Dirección:</span>
                <input type="text" name="direccion" class="validate-required" onpaste="return false" maxlength="50" placeholder="Dirección" required/>
              </div>
              <div class="col-sm-6 col-md-6 col-md-offset-0.5 input-with-label text-left">
                <span>Teléfono:</span>
                ...
                <input type="number" step="any" min="0" name="presupuesto" class="validate-required" placeholder="Presupuesto" required/>
              </div>
              <hr>
            </div>
            <div class="overflow-hidden">
