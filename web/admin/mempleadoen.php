...
<body class="scroll-assist">
              ...
              <li class="has-dropdown">
                ...
                <ul class="mega-menu">
                  ...
                  <li>
                    <ul>
                      <li>
                        <span class="title">Brranches</span>
                      </li>
                      <li>
                  ...
                  <li>
                    <ul>
                      <li>
                        <span class="title">Menssages</span>
                      </li>
                      <li>
                        <a href="mensajesen.php">Menssages</a>
                      </li>
                    </ul>
                  </li>
                  <li>
                ...
                <ul class="mega-menu">
                  <li>
                    <ul>
                      ...
                      <li>
                        <a href="aempleadoen.php?n=2">Accountan</a>
                      </li>
                      <li>
  ...
  if(isset($_POST['nombre'])){
    ...
    if(@$vari){
      ?>
      <script type="text/javascript">
      swal("¡GOOG JOB!", "Password changed!", "success")
      </script>
      <?php
    }else{
      ?>
  ...
  if (isset($_GET['msg'])) {
    if ($_GET['msg'] == 1) {
      ...
      ?>
      <script type="text/javascript">
      swal("¡GOO JOB!", "Changes Saved!", "success")
      </script>
      <?php
    }
  }
  ...
  <footer class="footer-1 bg-dark">
    <div class="container">
      <div class="row">
        <div class="col-sm-6">
          <span class="sub">CSSC 2016 - Pawnshop System</span>
        </div>
