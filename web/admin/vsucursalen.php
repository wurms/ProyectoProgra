      ...
      <div class="container">
        <div class="row">
          <div class="col-sm-12 text-center">
            <h4 class="uppercase mb16">Branches List</h4>
            <p class="lead mb64">
              These are all the branches in the platform.
            </p>
          </div>
        </div>
        <!--final columna-->
              ...
              <tbody>
                ...
                foreach ($con->query($consulta) as $key) {
                  ...
                  <tr>
                    ...
                    <td>
                      <a href="msucursalen.php?sid=<?=$key['sid']?>" class="remove-item" data-toggle="tooltip" data-placement="top" title="" data-original-title="Update Employee">
