...
if (isset($_POST['fechaini'])) {
	...
	$pdf->Cell(200,10,utf8_decode('Date: '.$hoy),0,1,'R');
	$pdf->SetFont('Arial','B',12);
	$pdf->Cell(200,8,utf8_decode($vsucursal[0][1]),0,1,'C');
	$pdf->Cell(200,4,utf8_decode('Operations Summary'),0,1,'C');
	$pdf->SetFont('Arial','B',10);
	$pdf->Cell(200,3,utf8_decode('(Dollar Amount)'),0,1,'C');
	$pdf->SetFont('Arial','B',12);
	$pdf->Cell(200,8,utf8_decode('OPERATIONS SUMMARY FROM '.$weekago.' TO '.$weeklater),0,1,'C');

	$pdf->SetFont('Arial','B',12);

	$pdf->Ln();
	$pdf->Cell(66,10,utf8_decode('CURRENT PLEDGES'),1,0,'C');
	$pdf->Cell(66,10,utf8_decode('SETTLED PLEDGES'),1,0,'C');
	$pdf->Cell(66,10,utf8_decode('STEPS TO SALES'),1,1,'C');
	$pdf->SetFont('Arial','',10);
	$pdf->Cell(33,5,utf8_decode('Total Pledges:'),0,0,'L');
	...
	$pdf->Cell(33,5,utf8_decode('Total Pieces:'),0,0,'L');
	$pdf->Cell(33,5,utf8_decode($acontratos),0,0,'R');
	$pdf->Cell(33,5,utf8_decode('Total Pieces:'),0,0,'L');
	$pdf->Cell(33,5,utf8_decode($bcontratos),0,0,'R');
	$pdf->Cell(33,5,utf8_decode('Total Pieces:'),0,0,'L');
	...
	$pdf->Cell(33,5,utf8_decode('Total Amount:'),0,0,'L');
	...
	$pdf->Cell(33,5,utf8_decode('Interest Received:'),0,0,'L');
	$pdf->Cell(33,5,utf8_decode($bintereses),0,0,'R');
	$pdf->Cell(33,5,utf8_decode('Total Received:'),0,0,'L');
	$ctotalcobrado = $cintereses + $civa;
	$pdf->Cell(33,5,utf8_decode($ctotalcobrado),0,1,'R');

	$pdf->Cell(66,5,utf8_decode(''),0,0,'L');
	$pdf->Cell(33,5,utf8_decode('V.A.T:'),0,0,'L');
	...
	$pdf->Ln();
	$pdf->Cell(66,10,utf8_decode('SOLD PLEDGES'),1,1,'C');
	$pdf->SetFont('Arial','',10);
	$pdf->Cell(33,5,utf8_decode('Total Pledges:'),0,0,'L');
	...
	$pdf->Cell(33,5,utf8_decode('Arrears:'),0,0,'L');
	...
	$pdf->SetFont('Arial','B',12);
	$pdf->Cell(66,5,utf8_decode(''),0,0,'L');
	$pdf->Cell(99,10,utf8_decode('INCOME / EXPENSE'),1,1,'C');
	...
	$pdf->SetFont('Arial','B',10);
	$pdf->Cell(66,5,utf8_decode(''),0,0,'L');
	$pdf->Cell(33,5,utf8_decode('TOTAL INCOME'),0,0,'L');
	$pdf->Cell(33,5,utf8_decode(':'),0,0,'L');
	$pdf->Cell(33,5,utf8_decode($ingresos),0,1,'R');

	$pdf->Cell(66,5,utf8_decode(''),0,0,'L');
	$pdf->Cell(33,5,utf8_decode('TOTAL EXPENSES'),0,0,'L');
	$pdf->Cell(33,5,utf8_decode(':'),0,0,'L');
	$pdf->Cell(33,5,utf8_decode($egresos),0,1,'R');

	$pdf->Cell(66,5,utf8_decode(''),0,0,'L');
	$pdf->Cell(33,5,utf8_decode('TOTAL VAT'),0,0,'L');
	$pdf->Cell(33,5,utf8_decode(':'),0,0,'L');
	...
	header("location: sresumenen.php");
	exit();
}
?>
