...
$contar = "SELECT * FROM tbprenda WHERE estado='2'";
...
<body class="scroll-assist">
  ...
  <div class="main-container">
    <?php
    $cprenda = "SELECT * FROM tbprenda WHERE sid='$sid' AND estado='2' LIMIT " .(($paginacion->get_page() - 1) * $resultados). "," . $resultados;
        ...
        <div class="container">
          <div class="row">
            <div class="col-sm-12 text-center">
              ...
              <p class="lead mb64">
                These are all the paid pledges in the platform.
              </p>
            </div>
          </div>
          <!--end of row-->
          <div class="row">
            <div class="col-md-10 col-md-offset-1">
              <div class="alert alert-danger alert-dismissible" role="alert">
                ...
                <strong>According to the platform!</strong> No paid pledges registered.
              </div>
            </div>
          </div>
          <!--end of row-->
