    ...
    <div class="module widget-handle language left">
        <ul class="menu">
            <li class="has-dropdown">
                ...
                <ul>
                    <li>
                        <a href="indexvcliente.php">ESPAÑOL</a>
                  </li>
                </ul>
              </li>
            </ul>
              ...
              <tbody>
                ...
                foreach ($con->query($consulta) as $key) {
                  ...
                  <tr>
                    ...
                    <td>
                      <a href="vcontratoen.php?cid=<?=$key['cid']?>" class="remove-item" data-toggle="tooltip" data-placement="top" title="" data-original-title="View Pledge">
                        <i class="ti-files"></i>
                      </a>
                    </td>
                  </tr>
