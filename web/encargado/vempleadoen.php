              ...
              <tbody>
                ...
                if (isset($_POST['busqueda'])) {
                  ...
                  if (count($con->query($consulta)->fetch_array()) == 0) {
                    ...
                    sweetAlert("¡ERROR!", "No clients matched", "error");
                    </script>
                    <?php
                  }
                } else {
                ...
                foreach ($con->query($consulta) as $key) {
                  ...
                  <tr>
                    ...
                    <td>
                      <a href="mempleadoen.php?eid=<?=$key['eid']?>" class="remove-item" data-toggle="tooltip" data-placement="top" title="" data-original-title="Modificar Empleado">
