...
<body class="scroll-assist">
  <div class="nav-container">
    ...
    <div class="module widget-handle language left">
        <ul class="menu">
            <li class="has-dropdown">
                <a href="sresumenen.php">ENGLISH</a>
                <ul>
                    <li>
                        <a href="sresumen.php">ESPAÑOL</a>
                  </li>
                </ul>
              </li>
            </ul>
    ...
    <section>
      <div class="col-md-8 col-md-offset-2 col-sm-10 col-sm-offset-1">
        <div class="feature boxed bg-secondary">
          <form method="post" target="_blank" action="resumenen.php" class="text-center form-envio" data-error="Complete all the fields correctly" data-success="¡Nuevo miembro ingresado!">
            <h4 class="uppercase mt48 mt-xs-0">Operations Summary</h4>
            <div class="overflow-hidden">
              ...
              <div class="col-sm-6 col-md-6 col-md-offset-0.5 input-with-label text-left">
                <span>Date 1</span>
                <input type="text" name="fechaini" minlength="10" maxlength="10" class="validate-required validate-fecha2" onpaste="return false" onkeypress="return solonumeros(this, '##/##/####',event)" placeholder="Date 1 (MM/DD/YYYY)" required/>
              </div>
              <div class="col-sm-6 col-md-6 col-md-offset-0.5 input-with-label text-left">
                <span>Date 2</span>
                <input type="text" name="fechafin" minlength="10" maxlength="10" class="validate-required validate-fecha2" onpaste="return false" onkeypress="return solonumeros(this, '##/##/####',event)" placeholder="Date 2 (MM/DD/YYYY)" required/>
              </div>
            </div>
            <div class="overflow-hidden">
