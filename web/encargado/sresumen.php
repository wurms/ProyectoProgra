    ...
    <section>
      <div class="col-md-8 col-md-offset-2 col-sm-10 col-sm-offset-1">
        <div class="feature boxed bg-secondary">
          <form method="post" action="resumen.php" class="text-center form-envio" data-error="La fecha es ingresada incorrectamente" data-success="¡Nuevo miembro ingresado!">
            <h4 class="uppercase mt48 mt-xs-0">Resumen semanal</h4>
            <div class="overflow-hidden">
              ...
              <div class="col-sm-6 col-md-6 col-md-offset-0.5 input-with-label text-left">
                <input type="text" name="fechaini" minlength="10" maxlength="10" class="validate-required validate-fecha2" onpaste="return false" onkeypress="return solonumeros(this, '##/##/####',event)" placeholder="Fecha 1 (MM/DD/AAAA)" required/>
              </div>
              <div class="col-sm-6 col-md-6 col-md-offset-0.5 input-with-label text-left">
                <input type="text" name="fechafin" minlength="10" maxlength="10" class="validate-required validate-fecha2" onpaste="return false" onkeypress="return solonumeros(this, '##/##/####',event)" placeholder="Fecha 2 (MM/DD/AAAA)" required/>
              </div>
            </div>
            <div class="overflow-hidden">
