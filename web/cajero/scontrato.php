...
if (isset($_POST['dui'])) {
  ...
  $cid = $varc[0][0];
  if ($varc) {
    header("location: vcontrato.php?cid=$cid");
    exit();
  } else {
...
<body class="scroll-assist">
  ...
  if (isset($_GET['msg'])) {
    if ($_GET['msg']==1) {
      ...
      ?>
      <script type="text/javascript">
      sweetAlert("¡ERROR!", "¡Empleado no tiene prendas actualmente!", "error");
      </script>
      <?php
    }
  }
      ...
      <div class="col-md-8 col-md-offset-2 col-sm-10 col-sm-offset-1">
        <div class="feature boxed bg-secondary">
          <form method="post" class="text-center form-envio" data-error="Completa todos los campos correctamente" data-success="¡Nuevo miembro ingresado!">
            <h4 class="uppercase mt48 mt-xs-0">Visualizar Contratos</h4>
