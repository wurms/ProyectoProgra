...
if (isset($_POST['pid'])) {
	...
	header("location: contratosen.php");
	exit();
}
...
$pdf->Ln(4);
$pdf->Cell(20,15,utf8_decode('and: '.$vcliente[0][2].' '.$vcliente[0][3].', DUI: '.$vcliente[0][1].', Address '.$vcliente[0][4].'. This pledge was printed by the client.'),'C');
...
$pdf->Cell(20,10,utf8_decode('Wight'),1,0,'C');
...
$pdf->Cell(20,10,utf8_decode('COMMISION'),1,0,'C');
