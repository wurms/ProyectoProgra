  ...
  <div class="main-container">
    ...
    if (isset($_POST['pid'])) {
      if(@$varm && @$varp){
        ...
        swal("¡PLAZO AUMENTADO!", "Su período se ha aumentado 5 días.", "success")
        </script>
        <?php
      }else{
        ?>
        ...
        <div class="container">
          <div class="row">
            <div class="col-sm-12 text-center">
              ...
              <p class="lead mb64">
                Estas son todas las prendas del cliente en la platforma.
              </p>
            </div>
          </div>
          <!--end of row-->
        ...
        <div class="container">
          <div class="row">
            <div class="col-sm-12 text-center">
              <h4 class="uppercase mb16">Listado de Prendas</h4>
              <p class="lead mb64">
                Estas son todas las prendas del cliente en la plataforma.
              </p>
            </div>
          </div>
          <!--final columna-->
                        ...
                        if($key['estado']==3 && $key['renovacion']!=1){
                          ...
                          <td>
                            <form method="post" class="text-center form-envio" data-error="Completa todos los campos correctamente" data-success="¡Archivo Abierto!">
                              <input type="hidden" value="<?=$key['pid']?>" name="pid" />
                              <button type="submit" style="margin-bottom: 5px; background-color: #4188D8; border-color: #4188D8">Renovar</button>
                            </form>
                          </td>
                          <?php
                        }
