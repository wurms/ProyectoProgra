...
<body class="scroll-assist">
  ...
  if(isset($_POST['planilla']) && !$vplanilla){
    if(@$var){
      ...
      swal("¡BUEN TRABAJO!", "Payroll Complete", "success")
      </script>
      <?php
    }else{
      ?>
  ...
  if (isset($_POST['planilla'])) {
    ...
    <script type="text/javascript">
      swal({
           title: 'ALERTA',
           text: 'The entered period is registered.',
           type: 'warning',
           ...
           function(isConfirm){
             if (isConfirm) {
               window.location="mplanillaen.php?planilla=<?=$planilla?>&mes=<?=$mes?>&ano=<?=$ano?>";
            }else{
              swal("CANCELED", "Payroll Saved", "error");
            }
          });
    </script>
    <?php
      ...
      <div class="col-md-8 col-md-offset-2 col-sm-10 col-sm-offset-1">
        <div class="feature boxed bg-secondary">
          <form method="post" class="text-center form-envio" data-error="Complete all the fields correctly" data-success="Payroll!">
            <h4 class="uppercase mt48 mt-xs-0">Step to Payroll</h4>
