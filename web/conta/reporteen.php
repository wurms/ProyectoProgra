...
$pdf->Ln(15);
$pdf->Cell(200,15,utf8_decode("Operations Report"),0,1,'C');
$pdf->SetFont('Arial','B','10');
$pdf->Cell(50,15,utf8_decode("Corresponding to"),0,0,'C');
$pdf->Cell(50,15,utf8_decode($mes."/".$dia."/".$ano),0,1,'C');

$pdf->SetTextColor(0,0,0);
$pdf->SetFont('Arial','B','10');
$pdf->SetFillColor(192,192,192);
$pdf->Cell(200,5,utf8_decode("Incomes"),0,1,'L',1);

$pdf->Cell(28.50,5,utf8_decode('Branch'),0,0,'L');
$pdf->Cell(42.8,5,utf8_decode('Acum. Budget'),0,0,'C');
$pdf->Cell(42.8,5,utf8_decode('Real Acum'),0,0,'C');
$pdf->Cell(42.8,5,utf8_decode('Variation'),0,0,'C');
$pdf->Cell(42.8,5,utf8_decode('% Accomplishment'),0,1,'C');
...
$pdf->SetFont('Arial','B','10');
$pdf->SetFillColor(192,192,192);
$pdf->Cell(200,5,utf8_decode("Wallet"),0,1,'L',1);


$pdf->SetFont('Arial','B','10');
$pdf->Cell(28.50,5,utf8_decode('Branch'),0,0,'L');
$pdf->Cell(28.50,5,utf8_decode('Initial of the month'),0,0,'C');
$pdf->Cell(28.50,5,utf8_decode('Final report'),0,0,'C');
$pdf->Cell(28.50,5,utf8_decode('Month budget'),0,0,'C');
$pdf->Cell(28.50,5,utf8_decode('Accomplish.'),0,0,'C');
$pdf->Cell(28.50,5,utf8_decode('Initial of the year'),0,0,'C');
$pdf->Cell(28.50,5,utf8_decode('Final report'),0,1,'C');
