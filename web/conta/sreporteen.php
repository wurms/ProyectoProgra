...
if (isset($_POST['fecha'])) {
  ...
  if ($vreporte) {
    header("location: reporteen.php?mes=$mes&dia=$dia&ano=$ano");
    exit();
  } else {
    ...
    if ($var) {
      ...
      header("location: sreporteen.php?msg=1");
      exit();
    }
  }
}
...
<body class="scroll-assist">
  ...
  if (isset($_GET['msg'])) {
    if ($_GET['msg'] == 1 ) {
      ...
      sweetAlert("¡ERROR!", "Verify the date entered.", "error");
      </script>
      <?php
    }
  }
    ...
    <section class="fullscreen">
      <div class="col-md-8 col-md-offset-2 col-sm-10 col-sm-offset-1">
        <div class="feature boxed bg-secondary">
          <form method="post" target="_blank" class="text-center form-envio" data-error="Complete all the fields correctly" data-success="¡Completado!">
            <h4 class="uppercase mt48 mt-xs-0">View Operations Report</h4>
            <div class="overflow-hidden">
              ...
              <div class="col-sm-6 col-md-6 col-md-offset-0.5 input-with-label text-left">
                ...
                <input type="text" name="fecha" minlength="10" maxlength="10" class="validate-required validate-fecha2" onpaste="return false" onkeypress="return solonumeros(this, '##/##/####',event)" placeholder="Date (MM/DD/YYYY)" required/>
              </div>
            </div>
            <div class="overflow-hidden">
