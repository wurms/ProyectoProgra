...
$pdf->Cell(340,5,utf8_decode("Generated: ".$hoy),0,1,'R',0);
if (@$csucursal) {
  $pdf->Cell(340,5,utf8_decode("Branch: ".$csucursal['nombre']),0,1,'R',0);
}
...
$pdf->Cell(340,15,utf8_decode("Report Form: General Payroll"),0,0,'C',1);
$pdf->Ln(20);

$pdf->SetFont('Arial','B','8');
$pdf->SetFillColor(192,192,192);
$pdf->Cell(214.78,7,utf8_decode("Type: General Payroll"),0,0,'L',1);
$pdf->Cell(41.74,7,utf8_decode("Payroll: ".$planilla),0,0,'C',1);
$pdf->Cell(41.74,7,utf8_decode("Year: ".$ano),0,0,'C',1);
$pdf->Cell(41.74,7,utf8_decode("Month: ".$mes),0,0,'C',1);
$pdf->Ln(9);

$pdf->SetFont('Arial','B',8);
$pdf->SetFillColor(192,192,192);
$pdf->Cell(7,10,utf8_decode('N°'),0,0,'C',1);
$pdf->Cell(28,10,utf8_decode('Name'),0,0,'C',1);
$pdf->Cell(17.89,10,utf8_decode('Salary'),0,0,'C',1);
$pdf->Cell(17.89,10,utf8_decode('Day. Sal.'),0,0,'C',1);
$pdf->Cell(17.89,10,utf8_decode('Workdays'),0,0,'C',1);
$pdf->Cell(17.89,10,utf8_decode('Earn. Sal.'),0,0,'C',1);
$pdf->Cell(17.89,10,utf8_decode('Bond'),0,0,'C',1);
$pdf->Cell(17.89,10,utf8_decode('A. Hours'),0,0,'C',1);
$pdf->Cell(17.89,10,utf8_decode('Ext. Hours.'),0,0,'C',1);
$pdf->Cell(17.89,10,utf8_decode('Vac.'),0,0,'C',1);
$pdf->Cell(17.89,10,utf8_decode('Total Earn.'),0,0,'C',1);
$pdf->Cell(17.89,10,utf8_decode('ISSS'),0,0,'C',1);
$pdf->Cell(17.89,10,utf8_decode('AFP'),0,0,'C',1);
$pdf->Cell(17.89,10,utf8_decode('Incom. grav.'),0,0,'C',1);
$pdf->Cell(17.89,10,utf8_decode('ISR'),0,0,'C',1);
$pdf->Cell(17.89,10,utf8_decode('O. Desc.'),0,0,'C',1);
$pdf->Cell(17.89,10,utf8_decode('Fin. Inst.'),0,0,'C',1);
$pdf->Cell(17.89,10,utf8_decode('To. Desc.'),0,0,'C',1);
$pdf->Cell(18.6,10,utf8_decode('To. to pay'),0,1,'C',1);
$pdf->Ln(2);
...
$pdf->SetFont('Arial','B',8);
$pdf->SetFillColor(192,192,192);
$pdf->Cell(106.56,10,utf8_decode('Total:'),0,0,'L',1);
...
$pdf->SetFont('Arial','',8);
if ($planilla == 1) {
  $pdf->Cell(50,10,utf8_decode('COMMENT: First Half'),0,1,'C');
} else {
  $pdf->Cell(50,10,utf8_decode('COMMENT: Second Half'),0,1,'C');
}
...
$pdf->Cell(90,5,utf8_decode('Made by'),0,0,'C');
$pdf->Cell(25,5,utf8_decode(''),0,0,'C');
$pdf->Cell(90,5,utf8_decode('Checked by'),0,0,'C');
$pdf->Cell(25,5,utf8_decode(''),0,0,'C');
$pdf->Cell(90,5,utf8_decode('Authorized by'),0,1,'C');
